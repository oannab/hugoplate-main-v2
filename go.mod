...
require (
	...
	github.com/nicokaiser/hugo-theme-gallery/v4 v4.3.0 // indirect
)

replace github.com/nicokaiser/hugo-theme-gallery/v4 => github.com/nicokaiser/hugo-theme-gallery/v4 v4.3.0
